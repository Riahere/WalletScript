            ...
            children: [
              ...
              _settingsCard([
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(children: [
                        const Icon(Icons.dark_mode_rounded, color: AppTheme.primary, size: 20),
                      ...
                      const Text('Accent Color',
                          style: TextStyle(color: AppTheme.onSurface, fontWeight: FontWeight.w700, fontSize: 14)),
              ...
              _settingsCard([
                _settingsRow(Icons.download_rounded, 'Export Financial Data',
                    trailing: const Icon(Icons.download_rounded, color: AppTheme.onSurfaceVariant, size: 18)),
                const Divider(height: 1, color: AppTheme.outline),
                _settingsRow(Icons.delete_outline_rounded, 'Clear Transaction History',
              ...
              _settingsCard([
                _settingsRow(Icons.help_outline_rounded, 'Help Center',
                    trailing: const Icon(Icons.open_in_new_rounded, color: AppTheme.onSurfaceVariant, size: 16)),
                const Divider(height: 1, color: AppTheme.outline),
  ...
  Widget _sectionLabel(String label) {
    return Text(label,
        style: const TextStyle(
            color: AppTheme.onSurfaceVariant, fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.8));
  }
